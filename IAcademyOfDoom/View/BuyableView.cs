   ...
   public class BuyableView
    {
        ...
        /// </summary>
        /// <param name="buyable">the logical placeable item</param>
        /// <param name="location">the location (top left corner) of the display</param>
        public BuyableView(Buyable buyable, Point location)
        {
            Buyable = buyable;
            Location = location;
        }
        ...
        public void Draw(Graphics graphics)
        {
            ...
            graphics.DrawString("Buyable: " + Buyable.ToString(), Settings.RoomFont, Settings.TextBrush, p);
        }
        /// <summary>
